...
# set terminal aqua 0 title "Figure 0" size 846,594 font "Helvetica,14" noenhanced dashed dl 0.5
# set output
unset clip points
set clip one
unset clip two
...
set xtics   (0.00000, 250000., 500000., 750000., 1.00000e+06)
...
GNUTERM = "aqua"
plot 'ratios.spec.market.uneven.0' u 1:3 w lines lt 1  title 'with market', ''  u 1:3:9:10 every 10  w errorbars lt 1 lw 0.5 notitle, 'ratios.spec.nomarket.uneven.0' u 1:3 w lines lt 2  title 'without market', ''  u 1:3:9:10 every 10  w errorbars lt 2 lw 0.5 notitle
#    EOF
